    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Seatings", t => t.SeatingUId, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.StyleBases", "SeatingUId", "dbo.Seatings");
            ...
            DropForeignKey("dbo.StyleBases", "ComponentBase_UId", "dbo.ComponentBases");
            DropForeignKey("dbo.StyleBases", "ComponentUId", "dbo.ComponentBases");
            ...
            DropForeignKey("dbo.StyleBases", "PriceGroupUId", "dbo.PriceGroups");
            ...
            DropIndex("dbo.StyleBases", new[] { "ComponentBase_UId" });
            DropIndex("dbo.StyleBases", new[] { "SeatingUId" });
            DropIndex("dbo.StyleBases", new[] { "ComponentUId" });
            DropIndex("dbo.StyleBases", new[] { "PriceGroupUId" });
