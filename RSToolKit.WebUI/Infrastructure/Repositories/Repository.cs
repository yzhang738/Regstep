...
namespace RSToolKit.WebUI.Infrastructure.Repositories
{
    /// <summary>
    ...
    public abstract class Repository<Titem>
        : IDisposable
        where Titem : class, IDataItem
    {
        ...
        public Repository(SecureUser secureUser = null)
        {
        ...
        /// <param name="secureUser">[optional] The user for permissions.</param>
        public Repository(EFDbContext context, SecureUser secureUser = null)
        {
        ...
        public virtual Titem Find(long id, bool ignoreException = false, bool ignorePermissions = false)
        {
            ...
            if (item != null)
                item.CreateAccess(ItemAccessTypes.Read, this._secureUser != null && this._secureUser.AppUser != null ? this._secureUser.AppUser.Id : "");
            return item;
        }
