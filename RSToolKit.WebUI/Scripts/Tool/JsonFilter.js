    ...
    this.Generate = function () {
        ...
        for (var i = 0; i < this.filters.length; i++) {
            ...
            if (t_header.Type === 'itemParent') {
                ...
                testHtml = '<option value="=="' + (t_filter.Equality === '==' ? ' selected="selected"' : '') + '>Equals</option><option value="!="' + (t_filter.Equality === '!=' ? ' selected="selected"' : '') + '>Not Equals</option><option value="in"' + (t_filter.Equality === 'in' ? ' selected="selected"' : '') + '>In</option><option value="notin"' + (t_filter.Equality === 'notin' ? ' selected="selected"' : '') + '>Not In</option>';
