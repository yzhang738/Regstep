...
///#source 1 1 /Scripts/versioning.js
//! Versioning
...
///#source 1 1 /Scripts/jQuery/Plugins/jquery-color.js
/**!
...
///#source 1 1 /Scripts/jQuery/Plugins/jsonData.js
(function ($) {
...
///#source 1 1 /Scripts/Tool/Layout/extensions.js
...
///#source 1 1 /Scripts/Tool/Layout/browserGap.js
...
///#source 1 1 /Scripts/Tool/Layout/prettyProcessing.js
...
prettyProcessing = processing = (function (_my, $) {
    ...
    _my.showPleaseWait = function (title, message, percent) {
        ...
        $('#bar_prettyProccessing').css('width', percent + '%');
        $('#title_prettyProccessing').html(title);
        $('#status_prettyProccessing').html(message);
        _my.div.modal('show');
    };
    _my.update = function (title, message, percent) {
        /// <signature>
...
///#source 1 1 /Scripts/Tool/Layout/breadCrumb.js
/* global RESTFUL */
...
///#source 1 1 /Scripts/Tool/Layout/restful.js
...
///#source 1 1 /Scripts/Bootstrap/Plugins/datetimepicker/bootstrap-datetimepicker.js
/* =========================================================
...
///#source 1 1 /Scripts/Tool/contactUpload.js
