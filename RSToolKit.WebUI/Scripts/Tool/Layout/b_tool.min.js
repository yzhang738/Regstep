function Version(n,t,i,r){var u=this;this.Major=0;this.Minor=0;this.Build=0;this.Iteration=0;typeof n=="number"&&(this.Major=n);typeof t=="number"&&(this.Minor=t);typeof i=="number"&&(this.Build=i);typeof r=="number"&&(this.Iteration=r);this.toString=function(){return u.Major+"."+u.Minor+"."+u.Build+"."+u.Iteration};this.Equals=function(n){var t=Versioning.ParseVersion(n);return u.Major===t.Major&&u.Minor===t.Minor&&u.Build===t.Build&&u.Iteration===t.Iteration};this.Compare=function(n){var t=Versioning.ParseVersion(n);return u.Major>t.Major?1:u.Major<t.Major?-1:u.Minor>t.Minor?1:u.Minor<t.Minor?-1:u.Build>t.Build?1:u.Build<t.Build?-1:u.Iteration>t.Iteration?1:u.Iteration<t.Iteration?-1:0}}function Crumb(){"use strict";this.Id="";this.ActionDate=new Date;this.Action="Action";this.Label="Action";this.Controller="Controller";this.Parameters={}}function UpdateCurrentCrumb(n,t,i,r){BREADCRUMB.CURRENT==null?setTimeout(function(){UpdateCurrentCrumb(n,t,i,r)},1e4):(typeof n!="undefined"&&n!==null&&(BREADCRUMB.CURRENT.Label=n),typeof t!="undefined"&&t!==null&&(BREADCRUMB.CURRENT.Controller=t),typeof i!="undefined"&&i!==null&&(BREADCRUMB.CURRENT.Action=i),typeof r!="undefined"&&r!==null&&(BREADCRUMB.CURRENT.parameters=r))}function UpdateCrumb(n){$("#crumb_"+n.Id).html(n.Label);var t=new XMLHttpRequest;t.open("put",window.location.origin+"/Account/Crumb");t.onerror=function(){};t.onload=function(t){try{if(t.currentTarget.status===200){var i=RESTFUL.parse(t.currentTarget);i.Success&&$("#crumb_"+n.Id).attr("href",i.href)}}catch(r){}};RESTFUL.ajaxHeader(t);RESTFUL.jsonHeader(t);try{t.send(JSON.stringify(AddJsonAntiForgeryToken(n)))}catch(i){}}function addAntiForgeryToken(n){var t="";return typeof jsonAntiForgeryToken=="undefined"&&(t=toolkit.jsonAntiForgeryToken),EXT.getName(n)==="FormData"?n.append("__RequestVerificationToken",t):n.__RequestVerificationToken=t,n}function AddJsonAntiForgeryToken(n){var t="";return typeof jsonAntiForgeryToken=="undefined"&&(t=toolkit.jsonAntiForgeryToken),EXT.getName(n)==="FormData"?n.append("__RequestVerificationToken",t):n.__RequestVerificationToken=t,n}function CheckStatus(n){upload_criticalError||(xhrS=new XMLHttpRequest,xhrS.open("get",n,!0),xhrS.onload=function(n){var t,i;if(upload_criticalError||upload_finished){$("#uploadProgress").modal("hide");return}t=JSON.parse(n.currentTarget.responseText);t.CriticalFailure?(upload_criticalError=!0,$("#uploadProgress").modal("hide"),alert(t.Message)):t.NeedsRectified?(upload_criticalError=!0,window.location.href=t.RectifyLocation):t.NeedsSheetSelection?(upload_criticalError=!0,window.location.href=t.SheetLocation):t.ProcessingComplete?t.UpdateComplete?(upload_finished=!0,clearInterval(upload_intervalId),$("#uploadProgressBar").css("width","100%"),$("#uploadStatus").html("Completed"),setTimeout(function(){$("#uploadProgress").modal("hide")},3e3)):(i=Math.ceil(t.ProcessingPercent)+"%",upload_updating||($("#uploadStatus").html("Updating Contacts"),upload_updating=!0),$("#uploadProgressBar").css("width",i)):(i=Math.ceil(t.ProcessingPercent)+"%",upload_processing||($("#uploadStatus").html("Processing Data"),upload_processing=!0),$("#uploadProgressBar").css("width",i))},xhrS.onerror=function(){if(upload_criticalError||upload_finished){$("#uploadProgress").modal("hide");return}upload_criticalError=!0;clearInterval(upload_intervalId);$("#uploadProgress").modal("hide");alert("Error Processing Data.")},xhrS.send())}var toolkit=function(n){return n.jsonAntiForgeryToken=document.getElementById("toolkitGlobal_jsonAntiForgeryToken").value,n.addJsonAntirForgeryToken=function(t){var i=n.jsonAntiForgeryToken;return EXT.getName(t)==="FormData"?t.append("__RequestVerificationToken",i):t.__RequestVerificationToken=i,t},n.addJsonAntiForgeryToken=function(t){var i=n.jsonAntiForgeryToken;return EXT.getName(t)==="FormData"?t.append("__RequestVerificationToken",i):t.__RequestVerificationToken=i,t},n.companyId=document.getElementById("toolkitGlobal_companyId").value,n}(toolkit||{}),Versioning,EXT,processing,prettyProcessing,BREADCRUMB,RESTFUL,RESTUFL_VERSION;
//! Versioning
Versioning={Version:new Version(1,0,0,0),ParseVersion:function(n){var r,u,f,i,t;return typeof n=="object"&&n.Major?n:typeof n=="string"?(i=0,!/\d+\.\d+\.\d+\.\d+/.test(n))?!1:(t=n.match(/(\d+)\.(\d+)\.(\d+)\.(\d+)/),t===null)?!1:isNaN(t[1])||isNaN(t[2]||isNaN(t[3])||isNaN(t[4]))?new Version:(r=parseInt(t[1],10),u=parseInt(t[2],10),f=parseInt(t[3],10),i=parseInt(t[4],10),new Version(r,u,f,i)):new Version}};
/*!
